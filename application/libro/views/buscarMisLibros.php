...
?>
  ...
  <section id="secondary_bar">
    ...
    <div class="breadcrumbs_container">
      <article class="breadcrumbs"><a href="../../inicio.php">Inicio</a> <div class="breadcrumb_divider"></div> <a class="current">Buscar Mis Libros</a></article>
    </div>
    ...
    <article class="module width_full">
      <header><h3>Informaci&oacute;n de B&uacute;squeda</h3></header>
        <div class="module_content">
          ...
          <form id="formSearchLibro" method="post" action="misLibros.php">
